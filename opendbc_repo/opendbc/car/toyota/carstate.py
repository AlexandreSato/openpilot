...
class CarState(CarStateBase):
  ...
  def update(self, can_parsers) -> structs.CarState:
    ...
    if (self.CP.carFingerprint == CAR.TOYOTA_COROLLA_TSS2 and self.CP.flags & ToyotaFlags.HYBRID.value):
      ...
      self.brakehold_condition_satisfied = (ret.standstill and self.params.get_bool("as_autohold") and not ret.gasPressed and
                                           not ret.cruiseState.enabled and (ret.gearShifter not in (self.GearShifter.reverse, self.GearShifter.park)))
