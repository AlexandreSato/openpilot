...
def create_maneuvers(kwargs):
  maneuvers = [
    # Maneuver(
    #   'approach stopped car at 10m/s, initial distance: 120m',
    #   duration=20.,
    #   initial_speed=25.,
    #   lead_relevancy=True,
    ...
    # ),
    Maneuver(
      'approach stopped car at 10m/s, initial distance 90m',
      duration=20.,
      initial_speed=10.,
      lead_relevancy=True,
    ...
    Maneuver(
      'steady state following a car at 10m/s, then lead decel to 0mph at 1m/s^2',
      duration=50.,
      initial_speed=10.,
      lead_relevancy=True,
    ...
    Maneuver(
      'steady state following a car at 10m/s, then lead decel to 0mph at 2m/s^2',
      duration=50.,
      initial_speed=10.,
      lead_relevancy=True,
      initial_distance_lead=35.,
    ...
    Maneuver(
      'steady state following a car at 10m/s, then lead decel to 0mph at 3m/s^2',
      duration=50.,
      initial_speed=10.,
      lead_relevancy=True,
      initial_distance_lead=35.,
    ...
    Maneuver(
      'steady state following a car at 7m/s, then lead decel to 0mph at 3+m/s^2',
      duration=40.,
      initial_speed=7.,
      lead_relevancy=True,
      initial_distance_lead=35.,
    ...
    Maneuver(
      "approach stopped car at 7m/s, with prob_lead_values",
      duration=30.,
      initial_speed=7.,
      lead_relevancy=True,
      initial_distance_lead=120.,
    ...
    Maneuver(
      "approach stopped car at 7m/s, with prob_throttle_values and pitch = -0.1",
      duration=30.,
      initial_speed=7.,
      lead_relevancy=True,
      initial_distance_lead=120.,
    ...
    Maneuver(
      "approach slower cut-in car at 7m/s",
      duration=20.,
      initial_speed=7.,
      lead_relevancy=True,
    ...
    # ),
    Maneuver(
      'cruising at 4.72 m/s while disabled',
      duration=20.,
      initial_speed=4.72,
